            ...
            <div className='container'>
                <div className='row footer-top py-3'>
                    <div className='col-md-6 py-3'>
                        <h4 className="text-info">Resume Builder Web App</h4>
                        <h6 className="text-white">Email: resumebuilder@gmail.com</h6>
                        <h6 className="text-white">Phone: +990 1234 56789</h6>
                    </div>
